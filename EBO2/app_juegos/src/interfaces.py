...
Ice.loadSlice("-I ./src/ --all ./src/JuegoSimonSay.ice")
import RoboCompJuegoSimonSay
Ice.loadSlice("-I ./src/ --all ./src/Pasapalabra.ice")
...
class Requires:
    def __init__(self, ice_connector):
        ...
        self.JuegoSimonSay = self.create_proxy("JuegoSimonSayProxy", RoboCompJuegoSimonSay.JuegoSimonSayPrx)

        self.Pasapalabra = self.create_proxy("PasapalabraProxy", RoboCompPasapalabra.PasapalabraPrx)

        self.StoryTelling = self.create_proxy("StoryTellingProxy", RoboCompStoryTelling.StoryTellingPrx)
...
class Implements:
    def __init__(self, ice_connector, default_handler):
        self.ice_connector = ice_connector
        self.gestorsg = self.create_adapter("GestorSG", gestorsgI.GestorSGI(default_handler))
